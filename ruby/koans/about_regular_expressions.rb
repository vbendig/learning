...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_a_regexp_can_search_a_string_for_matching_content
    assert_equal 'matchi', 'some matching content'[/matchi/]
  end
  ...
  def test_asterisk_means_zero_or_more
    ...
    assert_equal 'ac', 'aaaazceeeeacxxabc'[/ab*c/]
    assert_equal nil, 'aaaazceeee'[/ab*c/]
  ...
  #
  # Why?
  # Greediness: Greedy quantifiers first tries to repeat the token as many times as possible,
  # and gradually gives up matches as the engine backtracks to find an overall match.
  # abbbbb[/ab*/] will match abbbbb and not only ab
  ...
  # Character class is more efficient than alternation when using one letter,
  # but alternation is used with words
